...
<head>
    ...
    <title>Attorneyster-Testimonials</title>
                            ...
                            <div class="testimonial-item">
                                <div class="client-details">
                                    <div class="client-img">
                                        <img src="./images/client-pall.png" alt="pall" width='84' height='84'>
                                    </div>
                                ...
                                <div class="testimonial-quotes">
                                    <img src='./images/client-content.png' alt='Quotes' width='31' height='25' />
                                </div>
                            </div>
                            <p>There are  of Lorem Ipsum available, but the majority have su alteration in some form, by injected oir  which don't look even slightly believable.when an unknown printer took a galley of type and scrambled.</p>
                        </div>     
                    </li>
                    <li>
                        <div class="testimonial-area">
                    ...
                    <li>
                        <div class="testimonial-area">
                            <div class="testimonial-item">
                                <div class="client-details">
                                    <div class="client-img">
                                        <img src="./images/client-rose.png" alt="rose" width='84' height='84'>
                                    </div>
                    ...
                    <li>
                        <div class="testimonial-area">
                            <div class="testimonial-item">
                                <div class="client-details">
                                    <div class="client-img">
                                        <img src="./images/client-John.png" alt="John-David" width='84' height='84'>
                                    </div>
                    ...
                    <li>
                        <div class="testimonial-area">
                            <div class="testimonial-item">
                                <div class="client-details">
                                    <div class="client-img">
                                        <img src="./images/rinci.png" alt="Rinci pall" width='84' height='84'>
                                    </div>
                    ...
                    <li>
                       <div class="testimonial-area">
                            <div class="testimonial-item">
                                <div class="client-details">
                                    <div class="client-img">
                                        <img src="./images/peeter.png" alt="peeter" width='84' height='84'>
                                    </div>
